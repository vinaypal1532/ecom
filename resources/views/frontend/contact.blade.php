...
@section('title', 'Contact Us - HolidayThrill: Your Gateway to Memorable Journeys')

@section('description', 'Contact HolidayThrill for any inquiries or assistance. Discover our commitment to providing personalized and unforgettable travel experiences.')
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-7">
                    <form id="insertForm">
                        ...
                        <input type="text" name="mobile_no" class="w-100 form-control border-0 py-3 mb-4" placeholder="Your Mobile Number">
                ...
                <div class="col-lg-5">
                    ...
                    <div class="d-flex p-4 rounded bg-white">
                        ...
                        <div>
                            <h4>Telephone</h4>
                            <p class="mb-2">{{ $setting->mobile_no }}</p>
                        </div>
                    </div>
                </div>
            </div>
